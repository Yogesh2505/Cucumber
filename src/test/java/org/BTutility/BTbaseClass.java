...
//Webdriver	
	...
	public static void key(WebElement element, String data) {
...
//takescreenshot
	public static void toScreenShot(String name) throws IOException {
		...
		File dst = new File("C:\\Users\\ELCOT\\eclipse-workspace\\Cucumber\\screenshot\\"+name+".jpg");
...
//ExcelRead
	public static String toExcelRead(int rowNo,int cellNo) throws IOException {
	
		File f = new File("C:\\Users\\ELCOT\\eclipse-workspace\\Maven001\\excelsheet\\Datadruven.xlsx");
